...
# (NullPopPoCustom) Additional Systems to swap Disc/CD : PC-Engine / PC88 / FDS (internal mapping is obsoleted) 
# (NullPopPoCustom) 2 disk drives support : MSX / PC88 / PC98 / X1 / X68000
coreWithSwapSupport = {'hatari', 'cap32', 'bluemsx', 'dosbox_pure', 'flycast', 'np2kai', 'puae', 'px68k', 'vice_x64', 'vice_x64sc', 'vice_xplus4', 'vice_x128', 'pcsx_rearmed', 'duckstation', 'mednafen_psx', 'beetle-saturn', 'genesisplusgx', 'pce', 'pce_fast', 'fceumm', 'nestopia', 'quasi88', 'x1'};
