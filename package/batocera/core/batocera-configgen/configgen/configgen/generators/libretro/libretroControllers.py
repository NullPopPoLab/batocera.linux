...
# (NullPopPoCustom) Additional swappable : PC88 / X1 / FDS / PC Engine (internal mapping is obsoleted)
# (NullPopPoCustom) 2 disk drives support : PC88 / PC98 / X1 / X68000
coreWithSwapSupport = {'hatari', 'cap32', 'bluemsx', 'dosbox_pure', 'flycast', 'np2kai', 'puae', 'px68k', 'vice_x64', 'vice_x64sc', 'vice_xplus4', 'vice_x128', 'pcsx_rearmed', 'duckstation', 'mednafen_psx', 'beetle-saturn', 'genesisplusgx','picodrive','quasi88','x1', 'fceumm', 'nestopia', 'pce', 'pce_fast'};
