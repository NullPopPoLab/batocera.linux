...
# (NullPopPoCustom) Additional Systems to swap Disc/CD : PC-Engine / X1
# (NullPopPoCustom) Additional m3u support: PicoDrive / X1
coreWithSwapSupport = {'hatari', 'cap32', 'bluemsx', 'dosbox_pure', 'flycast', 'np2kai', 'puae', 'px68k', 'vice_x64', 'vice_x64sc', 'vice_xplus4', 'vice_x128', 'pcsx_rearmed', 'duckstation', 'mednafen_psx', 'beetle-saturn', 'genesisplusgx', 'pce', 'pce_fast','picodrive','x1'};
