...
ifeq ($(findstring dev,$(BATOCERA_SYSTEM_VERSION)),dev)
    BATOCERA_SPLASH_TGVERSION=$(BATOCERA_SYSTEM_CUSTOM_VERSION)-$(BATOCERA_SYSTEM_GIT_VERSION) $(BATOCERA_SYSTEM_DATE_TIME)
else
    BATOCERA_SPLASH_TGVERSION=$(BATOCERA_SYSTEM_CUSTOM_VERSION) $(BATOCERA_SYSTEM_DATE)
endif
